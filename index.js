...
function drawSegm(data, container, color) {
   var segm = data;
    var line = document.createElementNS('http://www.w3.org/2000/svg', 'line');
    line.setAttribute('x1', segm.s.x);
    line.setAttribute('y1', segm.s.y);
    line.setAttribute('x2', segm.e.x);
    line.setAttribute('y2', segm.e.y);
...
intersects(examples.first, examples.second).forEach(function (p) {
  //drawSegm(p, document.querySelector('svg.intersections'), 'red');
